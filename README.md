...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
    ...
    React is a component library that was built by Facebook to be used as an aid in building user interfaces.

1. Describe component state.

    A component state holds information over time which can be changed at later dates.

1. Describe props.

    A prop is similar to a global variable.
